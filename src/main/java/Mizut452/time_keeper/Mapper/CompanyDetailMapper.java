...
public interface CompanyDetailMapper {
    ...
    @Insert("INSERT INTO companyDetail(companyDetail_Cname, company_whatJob, company_strongPoint, company_weakPoint, company_treatment, company_welfare, company_flow, company_another) " +
    ...
    @Insert("INSERT INTO companyDetail(companyDetail_id, companyDetail_Cname)" +
    ...
    @Select("SELECT * FROM companyDetail WHERE companyDetail_Cname = #{companyDetail_Cname}")
    CompanyDetail findById(@Param("companyDetail_Cname") String companyName);
