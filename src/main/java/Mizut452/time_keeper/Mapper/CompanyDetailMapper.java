...
public interface CompanyDetailMapper {
    ...
    @Insert("INSERT INTO companyDetail(companyDetail_id, companyDetail_Cname, company_whatJob, company_strongPoint, company_weakPoint, company_treatment, company_welfare, company_flow, company_another) VALUE(#{companyDetail_id}, #{companyDetail_Cname}, '', '', '', '', '', '', ''")
